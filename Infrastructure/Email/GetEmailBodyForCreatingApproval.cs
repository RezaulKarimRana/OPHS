...
{
    public static class GetEmailBodyForCreatingApproval
    {
        public static string GenericEmailBody(string upperBodyPart, string estimateType, string Identification, string subject, string objective, string details, string fromTime, string toTime, string itemDetailsBodyPart,
            string totalPrice, string departmentSummaryPart, string particularSummaryPart, string approverListPart, string approverFeedBacks, string procurementApprovalPart)
        {
            ...
            string firstPart =
                @"<div align='center' style='font-family:Calibri; font-size:100%;' width='1000px'>
                    ...
                    <table id='email-content' width='100%' align='center' border='0' cellspacing='0' cellpadding='0' style='padding:5px 30px 0px 30px'>
                        ...
                        <!-- Email TOP-->
                        <tr>
                            <td style='padding-bottom:30px 0px 0px 0px'>
                        ...
                        <tr>
                            <td style='width:100%;padding:5px'>
                                <table align='center' border='0' cellspacing='0' cellpadding='0' style='width:100%'>
                                    <tbody>
                                    <tr>
                                        <td style='background-color:rgba(0,0,0,0);'><br><br>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
            ...
            string lastPart =
                    ...
                    <table id='last_email-content' width='100%' align='center' border='0' cellspacing='0' cellpadding='0' style='padding:15px 30px 10px 30px'>
                        <tbody style='text-align: justify'>
                        <tr>
                            <td>
                                <br/>
                            ...
                            <td>
                                <table id='email-footer-body' width='100%' align='center' border='0' cellspacing='0' cellpadding='0' style='background-color:#000000'>
                                    ...
                                    <tr>
                                        ...
                                        <span style='padding-left: 20px;color:#ffffff;font-size: small;font-weight:1200;'> This is an auto-generated mail, please do not reply.</span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
        ...
        public static string GenericPdfBodyOfEstimation(string upperBodyPart, string estimateType, string Identification, string subject, string objective, string details, string fromTime, string toTime, string itemDetailsBodyPart,
            string totalPrice, string departmentSummaryPart, string particularSummaryPart, string approverListPart, string approverFeedBacks, string procurementApprovalPart)
        {
            string secondPart = "";
            string forthPart = "";
